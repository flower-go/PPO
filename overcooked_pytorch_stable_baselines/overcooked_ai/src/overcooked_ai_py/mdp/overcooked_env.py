...
class Overcooked(gym.Env):
    ...
    def __init__(self):
        """Dummy constructor just to make EnvChecker pass, proper spaces should be set later with custom_init"""
        obs_shape = (42)
...
def get_vectorized_gym_env(base_env, gym_env_name, agent_idx, featurize_fn=None, start_state_fn=None, args=None):
    ...
    vectorized_gym_env = SubprocVecEnv([gym_env_fn] * args.num_workers ,start_method="forkserver")

...
parser.add_argument("--kl_diff_loss_coef", default=0.0, type=float, help="Coeficient for cross-entropy loss of population policies.")
parser.add_argument("--kl_diff_loss_clip", default=0.0, type=float, help="Ccross-entropy loss of population policies clipping.")

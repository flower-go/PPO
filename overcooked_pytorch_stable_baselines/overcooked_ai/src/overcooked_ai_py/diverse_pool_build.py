...
if __name__ == "__main__":
    ...
    model1 = PPO("MlpPolicy", gym_env, device="cpu")

    model2 = PPO("MlpPolicy", gym_env, device="cpu")
    gym_env.other_agent_model = model2

    model1.learn(10)    # TODO: it seems to work, now is time to git this basic version and then start trying inject agent/population logic

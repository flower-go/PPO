...
\begin{figure}[!ht]
    ...
    \caption{Forced coordination: Simple CNN, Average, ordered averaged cross-play of population final agents}
...
\begin{figure}[!ht]
    ...
    \caption{Forced coordination: FS Channels, Average, ordered averaged cross-play of population final agents}
...
\begin{figure}[!ht]
    ...
    \caption{Forced coordination: FS Tuple, Average, ordered averaged cross-play of population final agents}
...
If they have several previous states, they should be better able to predict their partner's current subgoal.
...
It seems that using both diversifying pressures for a given parameter size has a rather negative effect on the overall cooperation.
...
Nevertheless, it seems that the best overall configuration is the one without any diversity pressure, where the only source of diversity is the stochastic sampling of trajectories by previous partners.
